...
set_global_assignment -name VHDL_FILE ../../src/segment_decoder_pkg.vhd
set_global_assignment -name VHDL_FILE ../../src/clock_synchronizer_pkg.vhd
set_global_assignment -name VHDL_FILE ../../src/FSM_pkg.vhd
set_global_assignment -name VHDL_FILE ../../src/calculator.vhd
set_global_assignment -name VHDL_FILE ../../src/disp_diff.vhd
set_global_assignment -name VHDL_FILE ../../src/from_12_to_4.vhd
set_global_assignment -name VHDL_FILE ../../src/disp_sum.vhd
set_global_assignment -name VHDL_FILE ../../src/display_mux.vhd
set_global_assignment -name VHDL_FILE ../../src/input_a_state.vhd
set_global_assignment -name VHDL_FILE ../../src/input_b_state.vhd
set_global_assignment -name VHDL_FILE ../../src/rising_edge_synchronizer.vhd
set_global_assignment -name VHDL_FILE ../../src/segment_decoder.vhd
